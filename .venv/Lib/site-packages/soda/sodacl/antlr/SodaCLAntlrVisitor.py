...
class SodaCLAntlrVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by SodaCLAntlrParser#reconciliation_schema_check.
    def visitReconciliation_schema_check(self, ctx:SodaCLAntlrParser.Reconciliation_schema_checkContext):
        return self.visitChildren(ctx)
