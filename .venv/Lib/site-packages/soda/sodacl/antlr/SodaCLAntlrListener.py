...
class SodaCLAntlrListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by SodaCLAntlrParser#reconciliation_schema_check.
    def enterReconciliation_schema_check(self, ctx:SodaCLAntlrParser.Reconciliation_schema_checkContext):
        pass

    # Exit a parse tree produced by SodaCLAntlrParser#reconciliation_schema_check.
    def exitReconciliation_schema_check(self, ctx:SodaCLAntlrParser.Reconciliation_schema_checkContext):
        pass
