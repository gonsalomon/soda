...
class TableColumnsQuery(Query):
    ...
    def execute(self):
        self._initialize_column_rows(self.metric.schema_name)
        self._propagate_column_rows_to_metric_value()

    def _initialize_column_rows(self, schema_name: str | None = None):
        """
        ...
        self.sql = data_source.sql_get_table_columns(self.table.table_name, schema_name=schema_name)
